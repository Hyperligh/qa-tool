...
<script src= "/g5quality_2.0/Update_Dictionary.js" type = "text/javascript"> </script>
        ...
        <div class="container">
			...
			<!-- end: Header Menu -->
                        ...
                        <div id="search" class="col-lg-3 pull-right">
                            ...
                            <input type="text" placeholder="search by domain or date" autocomplete="off" id="searchbar">
